...
Strip.prototype.colour = Strip.prototype.color = function(color, opts) {
    ...
    if (color) {
        ...
        if(typeof(color) === "object") {
            ...
            color = ColorString.get.hex(color)
        }

        stripcolor = ColorString.get.rgb(color) || null;
    }
...
Pixel.prototype.colour = Pixel.prototype.color = function(color, opts) {
    ...
    if (color) {
        ...
        if(typeof(color) === "object") {
            ...
            color = ColorString.to.hex(color);
        }
        pixelcolor = ColorString.get.rgb(color) || null;
    } else {
        return pixel.color;
    }
    ...
    if (pixelcolor != null) {
        ...
        with (pixel.color) {
            ...
            g = pixelcolor[1];
            b = pixelcolor[2];
            hexcode = ColorString.to.hex(pixelcolor);
            color = ColorString.to.keyword(pixelcolor);
            rgb = pixelcolor;
        }
