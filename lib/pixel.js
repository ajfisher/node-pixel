    ...
    FIRMATA: {
        initialize: {
            value: function(opts) {
                ...
                data[6] = (colour_order << 5) | 9;
                data[7] = strip_length & FIRMATA_7BIT_MASK;
                data[8] = (strip_length >> 7) & FIRMATA_7BIT_MASK;
                data[9] = END_SYSEX;
        ...
        strip_color: {
            value: function(color) {
                ...
                data[0] = START_SYSEX;
                data[1] = PIXEL_COMMAND;
                data[2] = (strip.id << 4) | PIXEL_SET_STRIP;
    ...
    I2CBACKPACK: {
        ...
        show: {
            value: function() {
                ...
                var strip = strips.get(this);
                strip.io.i2cWrite(strip.i2c_address, [((strip.id<<4) | PIXEL_SHOW)]);
            },
        },
        strip_color: {
            value: function(color) {
                ...
                data[0] = (strip.id << 4) | PIXEL_SET_STRIP;
    ...
    FIRMATA: {
        ...
        pixel_color: {
            value: function(color) {
                ...
                data.push((pixel.strip_id << 4) | PIXEL_SET_PIXEL);
