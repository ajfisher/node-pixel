    ...
    FIRMATA: {
        ...
        strip_color: {
            value: function(color) {
                ...
                data[7] = (color >> 28) & FIRMATA_7BIT_MASK;
                data[8] = END_SYSEX;
    ...
    I2CBACKPACK: {
        ...
        strip_color: {
            value: function(color) {
                ...
                data[5] = (color >> 28) & FIRMATA_7BIT_MASK;
                try {
    ...
    FIRMATA: {
        initialize: {
            value: function(opts) {
                ...
                var pixel = {
                    ...
                    id: opts.addr,
                    color: {
                        r: 0, g: 0, b: 0, w:0, hexcode: "#000000", color: "black", rgb: [0,0,0,0], rgbw: [0,0,0,0],
                    },
        ...
        pixel_color: {
            value: function(color) {
                ...
                data.push((color >> 28) & FIRMATA_7BIT_MASK);
                data.push(END_SYSEX);
...
Pixel.prototype.colour = Pixel.prototype.color = function(color, opts) {
    ...
    if (color) {
        ...
        if(typeof(color) === "object") {
            ...
            console.log('pixelxolor:', pixelcolor);
