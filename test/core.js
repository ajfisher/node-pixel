...
exports["Strip - Firmata"] = {
    ...
    stripColour: function(test) {
        ...
        strip.on("ready", function() {
            ...
            strip.color("#FFFFFF");
            test.deepEqual(strip.pixel(1).color(), colourcheck, "Check colours set");
            ...
            strip.color("blue");
            test.deepEqual(strip.pixel(1).color(), colourcheck, "Colour set using name");
            ...
            strip.color([0, 255, 0]);
            test.deepEqual(strip.pixel(1).color(), colourcheck, "Colour set using options");
